...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        in_credit_account_id = ICPSudo.get("res.config.settings",'in_credit_account_id',)
        in_debit_account_id = ICPSudo.get("res.config.settings",'in_debit_account_id',)
        out_credit_account_id = ICPSudo.get("res.config.settings",'out_credit_account_id',)
        out_debit_account_id = ICPSudo.get("res.config.settings",'out_debit_account_id',)
        deposite_account_id = ICPSudo.get("res.config.settings",'deposite_account_id',)
        specific_journal_id = ICPSudo.get("res.config.settings",'specific_journal_id',)
    ...
    def set_values(self):
        ...
        ICPSudo = self.env['ir.default'].sudo()
        ICPSudo.set("res.config.settings",'in_credit_account_id',self.in_credit_account_id.id)
        ICPSudo.set("res.config.settings",'in_debit_account_id',self.in_debit_account_id.id)
        ICPSudo.set("res.config.settings",'out_credit_account_id',self.out_credit_account_id.id)
        ICPSudo.set("res.config.settings",'out_debit_account_id',self.out_debit_account_id.id)
        ICPSudo.set("res.config.settings",'deposite_account_id',self.deposite_account_id.id)
        ICPSudo.set("res.config.settings",'specific_journal_id',self.specific_journal_id.id)'''
